...
class PathwayService:
    def __init__(
        ...
        pathway_repo: PathwayRepository,
        pathway_item_repo: PathwayItemRepository,
    ):
        self.db = db
    ...
    async def create_pathway_with_product(
        self, pathway_data: PathwayCreateWithProduct
    ) -> uuid.UUID:
        """
        ...
        try:
            ...
            raise ServiceException(
                status_code=500,
                detail="Failed to create pathway with product",
    ...
    async def get_pathway_by_id(self, pathway_id: uuid.UUID):
        try:
            ...
            raise ServiceException(
                status_code=500,
                detail="Failed to fetch pathway by id",
    ...
    async def get_all_pathways(
        ...
        try:
            ...
            raise ServiceException(
                status_code=500,
                detail="Failed to fetch all pathways",
                additional_info={
                    "error": str(e),
                    "page": page,
                    "limit": limit,

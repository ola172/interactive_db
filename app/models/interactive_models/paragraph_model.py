...
class InteractiveParagraphModel(Base):
    ...
    paragraph_keywords = relationship(
        "InteractiveKeyWordModel", back_populates="paragraph"
    )
    paragraph_visual = relationship(
        "VisualItemModel", back_populates="paragraph", uselist=False
    )
